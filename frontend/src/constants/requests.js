...
/** Статусы заявок для фильтров UI */
export const ALLOWED_STATUSES = ['NEW', 'IN_PROGRESS', 'DONE', 'CANCELLED']
...
/** Подписи районов/приоритетов/типов — см. vue-i18n `labels.*` в locales/*.json */
