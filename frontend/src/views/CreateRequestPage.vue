      ...
      <div class="container form-wrapper">
        ...
        <div class="form-content">
          ...
          <div class="form-step" :class="{ active: currentStep === 1 }">
            ...
            <div class="problem-types">
              <label v-for="type in problemTypes" :key="type.id" class="problem-type-card">
                <input type="radio" v-model="form.problemType" :value="type.id" />
                <div class="card-content">
                  <div class="card-icon" :class="type.iconClass">
                    <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6"/><path d="M12 18v-6"/><path d="M9 15h6"/></svg>
                  </div>
                  <h3>{{ type.title }}</h3>
          ...
          <div class="form-step" :class="{ active: currentStep === 2 }">
            ...
            <div class="info-box">
              <svg width="20" height="20" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="2"><circle cx="10" cy="10" r="8"/><path d="M10 6v4M10 14h.01"/></svg>
              <div>
            ...
            <div class="form-grid">
              <div class="form-group full-width">
                ...
                <input id="address" type="text" v-model="form.address" class="form-control" placeholder="г. Алматы, ул. Абая, 150" />
              </div>
              <div class="form-group full-width">
                <label for="description">Описание</label>
                <textarea id="description" v-model="form.description" class="form-control" placeholder="Опишите, что нужно: количество людей, особые условия, срочность..." rows="4"></textarea>
              </div>
              ...
              <div class="form-group">
                ...
                <input id="people" type="number" v-model.number="form.peopleCount" class="form-control" min="1" placeholder="1" />
              </div>
            </div>
            <div class="form-actions">
          ...
          <div class="form-step" :class="{ active: currentStep === 3 }">
            ...
            <div class="form-grid">
              <div class="form-group">
                ...
                <input id="contactName" type="text" v-model="form.contactName" class="form-control" placeholder="Иван Иванов" />
              </div>
              <div class="form-group">
                <label for="contactPhone">Телефон</label>
                <input id="contactPhone" type="tel" v-model="form.contactPhone" class="form-control" placeholder="+7 (___) ___-__-__" />
              </div>
              <div class="form-group full-width">
