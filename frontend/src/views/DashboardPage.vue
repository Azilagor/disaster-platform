  ...
  <div class="dashboard-layout">
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <router-link to="/create-request" class="nav-item">
    ...
    <main class="main-content">
      <div class="topbar">
        ...
        <div class="topbar-right">
          ...
          <div class="user-menu">
            <img :src="userAvatar" alt="" class="user-avatar" width="40" height="40" />
            <div class="user-info">
...
const userName = computed(() => user.firstName ? `${user.firstName} ${user.lastName || ''}`.trim() || 'Пользователь' : 'Пользователь')
const userRole = computed(() => ({ user: 'Пользователь', volunteer: 'Волонтёр', coordinator: 'Координатор' }[user.role] || 'Пользователь'))
const userAvatar = 'https://api.dicebear.com/7.x/avataaars/svg?seed=' + encodeURIComponent(user.email || 'user')
